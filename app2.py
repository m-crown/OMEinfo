...
sidebar = html.Div(
    [
        dcc.Upload(
                    id='upload-data',
                    children=html.Div(html.A('Drag and Drop or Select Files'), style =UPLOAD_STYLE),
...
app.layout = html.Div(
    [   
        dbc.Row(dbc.Col(
            [dbc.NavbarSimple(
                children=[
                    html.Img(src='data:image/png;base64,{}'.format(HBBE_LOGO_BASE64), height = "100px"),
                    ],
            brand="OME.info",
            className = "h1",
            brand_href="#",
        ...
        dbc.Row([
            ...
            dbc.Col([dbc.Row(dbc.Col(html.Div(id ="map_fill"))),
                    dbc.Row(
                        [
                            dbc.Col(dbc.Card(id='Rurality_bar'),style={'margin': '10px'}),
                            dbc.Col(dbc.Card(id='Sample_Location'), style={'margin': '10px'})
                        ]
                    ),
                    dbc.Row(
                        [       
...
def update_table(df):
    ...
    if df:
        ...
        table = html.Div(dash_table.DataTable(
                ...
                page_size = 10,
                export_format="csv",
                style_header={'backgroundColor': 'rgba(0, 0, 0, 0.03)', "font-family": "sans-serif"},
                style_cell={
                'font-family':"sans-serif",
                'backgroundColor': 'rgba(0, 0, 0, 0)'}), style={'margin': '10px'})
