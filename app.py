...
sidebar = html.Div(
    [
        ...
        dbc.Nav(
            [
                dbc.NavLink("Home", href="/", active="partial", style={'margin': '10px'}),
                dbc.NavLink("Page 1", href="/page-1", active="partial", style={'margin': '10px'}),
                dbc.NavLink("Page 2", href="/page-2", active="partial", style={'margin': '10px'}),
            ],
            vertical=True,
            pills=True
        ),
